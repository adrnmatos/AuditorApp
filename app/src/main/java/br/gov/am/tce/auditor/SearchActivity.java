...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Spinner municipioSpinner = findViewById(R.id.searchMunicipio_SPN);
        ...
        Spinner jurisdicionadoSpinner = findViewById(R.id.searchJurisdicionado_SPN);
        ...
        Spinner exercicioSpinner = findViewById(R.id.searchExercicio_SPN);
        ...
        Button buscar_btn = findViewById(R.id.searchBuscarContratos_BTN);
    ...
    private class FetchItemsTask extends AsyncTask<String, Void, List<Contrato>> {
        ...
        protected List<Contrato> doInBackground(String... args) {
            ...
            return new EContasFetchr().fetchContracts(municipio_str, jurisdicionado_str, exercicio_str);
        }

        @Override
        protected void onPostExecute(List<Contrato> contratos) {
            Intent intent = ContratoPagerActivity.newIntent(SearchActivity.this, contratos);
